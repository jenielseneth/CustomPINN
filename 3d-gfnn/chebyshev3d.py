...
from data_generation_utils3d import sample_random_mesh_points_3d
from generate_data3d import source_term
from plot_utils3d import plot_points
...
if __name__ == "__main__":
    domain = (0,1,0,1)
    eval_points = sample_random_mesh_points_3d(domain, 30)
