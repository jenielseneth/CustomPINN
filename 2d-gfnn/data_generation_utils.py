...
def generate_points(domain, u_gt_funcs, f_funcs, save_dir: str, u_mesh_num_points: tuple, f_mesh_num_points: tuple, 
    ...
    for i, (u_gt_func, f_func) in tqdm(enumerate(zip(u_gt_funcs, f_funcs)), total=len(u_gt_funcs)):
        ...
        mesh_points = sample_points(domain=domain, mesh_size=u_mesh_num_points, mesh_type=u_mesh_type, boundary=False)
        ...
        f_mesh = sample_points(domain=domain, mesh_size=f_mesh_num_points, mesh_type=f_mesh_type, boundary=False)
